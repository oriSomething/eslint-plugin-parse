    ...
    return {
        "CallExpression": function(node) {
            ...
            if (optionKeys.indexOf("success") !== -1) {
                ...
                context.report(successCallback, "Prefer use `then` or `done` instead of `success` callback");
            }
            ...
            if (optionKeys.indexOf("error") !== -1) {
                ...
                context.report(errorCallback, "Prefer use `then` or `fail` instead of `error` callback");
            }
        }
    };
};
